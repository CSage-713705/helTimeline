          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-100 font-sans max-w-6xl px-2 text-lg leading-relaxed mb-6 justify">
                {i18n.language === 'zh' ? '您可以阅览各个作者如何参与其媒体构建，了解它们如何影响故事的诠释。' : 'You can see how authors actively shaped their medium of publication, and how that medium, in turn, fundamentally shaped the narrative\'s form and its interpretation.'}
              </p>
            </div>
          </section>
